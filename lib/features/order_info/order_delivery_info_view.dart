...
import '../../core/widgets/delivery_info_widget.dart';
import '../home/presentation/manager/cubit.dart';
import '../home/presentation/manager/states.dart';

class OrderDeliveryInfoView extends StatelessWidget {
  const OrderDeliveryInfoView({super.key});
  @override
                      ...
                      children: [
                        Flexible(
                          ...
                          child: ListView.builder(
                            shrinkWrap: true,
                            itemCount: cubit.orderDeliverySteps.length,
                            itemBuilder: (context, index) {
                              final step = cubit.orderDeliverySteps[index];
                              OrderStatus orderStatus = step['orderStatus'];
                              final bool isLast =
                                  index == cubit.orderDeliverySteps.length - 1;
                              return Row(
